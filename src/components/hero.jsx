...
const hero = () => (
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      ...
      "
      >
        <h1 className="md:flex-1  font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px] ">
          The Next
          <br className="sm:block hidden" />{" "}
          <span className="text-gradient">Generation</span>{" "}
        </h1>
        <div className="ss:flex max-md:flex-1  hidden  md:mr-4  mr-0">
          <Getstarted />
        </div>
      </div>
    ...
    <div
      className={`flex-1 md:flex ${styles.flexCenter} md:my-0 my-10 relative hidden`}
    >
      <img
        src={robot}
        alt="billing
    ...
    <div className={`ss:hidden justify-start items-center px-11 mt-5`}>
      <Getstarted />
    </div>
  </section>
);
